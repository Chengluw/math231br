...
\begin{hwexercise} Discuss: given a vector bundle $E \to X$, can we recover the vector bundle $E$ from the sheaf $\Sec(-,E)$? If so, how? If not, what extra data would you need to rebuild $E$?
\end{hwexercise}
...
\begin{align*}
    f(x_1, \ldots, x_n) = \sum_{i=1}^n \int_0^1 \frac{df}{dx_i}(tx_1,tx_2, \ldots, tx_n) dt.
\end{align*}
\end{hwexercise}
