...
\begin{hwexercise} Let $G$ be a topological group (not assumed to be abelian). Check carefully that the non-abelian \v{C}ech cohomology $\check{H}^1(\mathcal{U},G)$ is a group.
\end{hwexercise}
