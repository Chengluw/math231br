...
\begin{align*}
    H^\ast(\Gr_\C(k,\infty);\Z) \cong \Z[c_1, \ldots, c_k],
\end{align*}
...
We can generalize this construction of the flag bundle of a rank two bundle as a projectivization. Given any vector bundle $E \to X$ of rank $r$, we denote by $\mathbb{P}(E)$ the \emph{projectivization} of the vector bundle, whose fiber over $x\in X$ is $\mathbb{P}(E_x)$. The projectivized bundle $\mathbb{P}(E) \to X$ is a fiber bundle with structure group $\GL_r(\C)$ and fiber $\CP^{r-1}$.
\end{definition}
