...
\begin{notation} We will use $\td(M) \in H^\ast(M,\Q)$ to denote the total Todd class, and we will denote by $\Td(M) = \int_M \Td(TM)\in \Q$ the associated Todd genus.
\end{notation}
...
\begin{align*}
    \phi_{\Td}([\CP^n]) = \res_1 \left( \frac{z^n dz}{(z-1)^{n+1}} \right) = 1.
\end{align*}
\end{proof}
